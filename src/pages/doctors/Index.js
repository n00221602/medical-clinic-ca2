            ...
            <Row className="d-flex flex flex-wrap justify-center">
                    ...
                    {doctors.map(({ id, first_name, last_name, email, phone, specialisation }) => (
                        <div class="p-6 w-5/12 m-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <h6 class="mb-2 text-1xl font-bold  text-gray-900 dark:text-white">Specialisation: {specialisation}</h6>
                            ...
                            <a href={`/doctors/${id}`} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 duration-300">
                                View More
