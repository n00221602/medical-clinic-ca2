...
const EditPatient = () => {
    ...
    return (
        ...
        //     <div>
        //     <input type="text" placeholder="First Name" name="first_name" value={form.first_name} onChange={handleChange}/><br/>
        //         <input type="text" placeholder="Last Name" name="last_name" value={form.last_name} onChange={handleChange}/><br/>
        //         <input type="email" placeholder="Email" name="email" value={form.email} onChange={handleChange}/><br/>
        //         <input type="text" placeholder="Phone - 10 digits" name="phone" value={form.phone} onChange={handleChange}/><br/>
        //         <input type="text" placeholder="YYYY/MM/DD" name="date_of_birth" value={form.date_of_birth} onChange={handleChange}/><br/>
        //         <input type="text" placeholder="Address" name="address" value={form.address} onChange={handleChange}/><br/>
                
        //         <button className="btn btn-success btn-wide text-white" onClick={handleSubmit}>Submit</button>
        //     </div>
